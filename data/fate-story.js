...
extras.photoMission.push("拍下今天最有生活气的一扇窗", "记录一张清晨或夜晚的街景", "拍一张只属于这次出发的车票", "用同一个姿势在两个地点拍照", "记录一顿饭从上桌到吃完");
extras.surprise.push("跟着一个顺眼的招牌走到街尾", "买一份平时不会主动选择的小吃", "让同行者闭眼选一家店进去看看", "在地图上随机选一条街走二十分钟", "找到一个和出发地同名的店或地名", "为旅程买一件十元以内的小纪念品");
...
extras.ending.push("回到住处把当天的东西放好", "把明天要带的东西提前准备好", "结束前确认返程时间和路线", "给同行的人发一张今天最喜欢的照片");
